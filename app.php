       ...
       <!--history and activity detail-->
        <article id="arc2"  >
           <?php
              ...
              $sql="SELECT activity_detail FROM playerinfo WHERE pname='$rt' AND activity_detail IS NOT NULL";
             if ($result=mysqli_query($conn,$sql))
            {
               ...
               while ($row=mysqli_fetch_row($result))
                ...
                mysqli_free_result($result);
                          ...
                          $sql="SELECT history_detail FROM playerinfo WHERE pname='$rt' AND history_detail IS NOT NULL";
